...
public final class AppConstant {
    ...
    public static final String ACTION_CONNECT_INFO = "connect_info";
    ...
    public static final String USER_SERVICE_NAME = "_user_service";
    ...
    public static final String NOTIFICATION_CHANEL_ID = "channel1";
